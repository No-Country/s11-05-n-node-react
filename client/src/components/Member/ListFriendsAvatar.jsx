...
import { AiOutlineMinusCircle, AiFillHeart, AiOutlineHeart } from "react-icons/ai";
import { useDispatch, useSelector } from "react-redux";
import { removeMemberFromSelect } from "../../store/state/membersSlice";
...
const ListFriendsAvatar = ({ member }) => {
    ...
    const isSelected = () => {
        return friends && friends.findIndex(item => item === member) !== -1
            ? true
            : false;
    };
    ...
    return (
        ...
        >
            ...
            {isSelected() ? (
                ...
                <button className="absolute -bottom-2 -right-4" onClick={() => dispatch(addFriend(member._id))}>
                    <AiFillHeart color="#00ff00" size={32} className="rounded-full" />
