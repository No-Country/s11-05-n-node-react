...
const Navbar = () => {
    ...
    return (
        <nav className="flex gap-2 w-full  h-[56px]  top-0 px-3 fixed  bg-gray-200 ">
            ...
            <ul className="flex justify-end items-center gap-3 w-[80%]  h-full ">
                ...
                <li className="w-[20%]  h-[60%]" >
                    <Link to="/login" className="flex justify-center items-center bg-[#bebebe] text-white rounded-md hover:bg-slate-500 transition-colors cursor-pointer  h-full w-full">
                        login
                    </Link>
                </li>
                <li className="w-[20%] h-[60%]">
                    <Link to="/register" className="flex justify-center items-center bg-[#bebebe] text-white rounded-md hover:bg-slate-500 transition-colors cursor-pointer h-full w-full">
                        registro
                    </Link>
                </li>
