...
const links = [
    { to: "/", label: "Perfil", icon: <RiUserFill className="w-[25px] h-[25px] rounded-full bg-[#babbbd] text-[#1E1F24]" /> },
...
const SidebarHome = () => {
    ...
    return (
        <>
            <section className={`bg-[#1E1F24] text-[#babbbd] fixed ${open ? "-left-0" : "-left-full"}  lg:left-0 top-0 w-64 h-full p-8 flex flex-col justify-between transition-all z-50`}>
                <div>
                    <nav>
                        <Link
                            to="/"
                        ...
                        <div
                            className="flex flex-col w-full gap-4 py-4 rounded-lg font-bold text-[1rem]">
                            <span className="flex justify-between items-center gap-4 ml-2"> <RiEqualizerFill />
                ...
                <button onClick={toggle} className="lg:hidden fixed right-4 bottom-4 bg-[#1E1F24] text-[#914a08] rounded-full text-xl p-3 z-50">
