...
const HeaderHome = () => {
  ...
  return (
    <>
      ...
      <Link to="/profile" className="flex items-center text-transparent bg-clip-text bg-gradient-to-t from-slate-300 to-white text-xl font-medium gap-5 capitalize">
