...
function About() {
  const devs = [
    ...
    },
    {
      id: 5,
      name: "Yein España",
      image: "https://cdn.discordapp.com/avatars/906564650240466996/513cc1b5ed82e339d0c1e9a345ecfbce.webp?size=240",
    ...
    },
    {
      ...
      image: "https://media.licdn.com/dms/image/D4D35AQGsZMpXXEJdVw/profile-framedphoto-shrink_400_400/0/1696365436483?e=1699563600&v=beta&t=KMzeg15B7hgarzCookXZ8kQX8jkPXqMWTjmUfDG_kc0",
    ...
    },
    {
      id: 11,
      name: "Karem Carranza",
      image: "https://pps.services.adobe.com/api/profile/D8FD0BB85C30A9870A495DE8@AdobeID/image/ee919a99-887c-4e3d-aed8-0194d83aa7c9/230",
      github: null,
    ...
    },
    {
      id: 12,
      name: "Marcela Ruiz",
      image: "https://media.licdn.com/dms/image/D4E03AQE8jx0CFEjb6g/profile-displayphoto-shrink_400_400/0/1691432030137?e=1704326400&v=beta&t=06b18VWYbN9WCCkxAVdYi9y8TXWtqjx7p3Zv097evfY",
      github: null,
      behance: null,
    ...
    },
    {
      ...
      image: "https://media.licdn.com/dms/image/D4E35AQErjfv86pgHeg/profile-framedphoto-shrink_800_800/0/1670791559162?e=1699563600&v=beta&t=QB2AvlXN9Elw4GMA5mBLZp1V7W-QvsV5LJFNcWwNVKY",
      github: null,
      behance: null,
  ...
  return (
    <section className="text-white max-w-screen-xl w-[85%] mx-auto my-10 flex flex-col gap-10 background-circle">
      <h1 className='text-5xl max-sm:text-center sm:text-6xl font-bold -tracking-wide'>
        <span className='text-transparent bg-clip-text bg-gradient-to-t from-slate-300 to-white'>{"Team Let's"}</span>{" "}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 w-full h-fit gap-5">
        {
          devs.map(dev => (
            <div key={dev.id} className="flex flex-col gap-2 border bg-neutral-950 border-white/10 p-4 rounded-2xl font-mono transition duration-200 hover:border-white/20 hover:bg-neutral-900">
              <img
              ...
              />
              <div>
                <span className="block text-xl truncate font-medium" title={dev.name}>{dev.name}</span>

                <div className="flex flex-wrap gap-2 justify-between mt-1.5">
                  <span className="bg-slate-900 border border-white/20 py-0.5 px-2.5 rounded-md block w-fit text-sm">{dev.role}</span>
      ...
      <Link to="/" className='ml-auto pressable bg-gradient-to-b from-[#B5FF16] to-green-600 text-black/90 text-lg w-fit py-2 px-4 rounded-md font-medium'>Volver al Inicio</Link>
    </section>
  )
}
